...
ActiveRecord::Schema[7.0].define(version: 2022_11_30_150752) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.bigint "phrase_country_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["phrase_country_id"], name: "index_favorites_on_phrase_country_id"
  ...
  add_foreign_key "favorites", "phrase_countries"
